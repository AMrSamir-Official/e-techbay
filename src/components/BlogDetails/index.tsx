      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[750px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div>
            ...
            <p className="mb-6">
              2. Shipping Address: Include your street address, city, state, zip
              code, and country. Make sure it's complete and accurate to avoid
              delivery delays.
            </p>

            <p className="mb-6">
              3. **Phone Number**: A valid phone number helps us to reach you in
            ...
            <p>
              ...
              shipping information. If you notice any errors after submitting,
              feel free to contact our customer support team to make necessary
