          ...
          <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-12.5">
            ...
            <div className="lg:max-w-[750px] w-full">
              ...
              <div>
                ...
                <p className="mb-6">
                  To ensure timely and accurate delivery, we need the following
                  information for shipping:
                </p>

                <p className="mb-6">
                  1. **Full Name**: Please provide your full name for proper
                  identification.
                </p>

                <p className="mb-6">
                  2. Shipping Address: Include your street address, city, state,
                  zip code, and country. Make sure it's complete and accurate to
                  avoid delivery delays.
                </p>

                <p className="mb-6">
                  3. **Phone Number**: A valid phone number helps us to reach
                  you in case of any delivery issues.
                </p>

                <p className="mb-6">
                  4. Email Address: For tracking and order updates, providing a
                  valid email address is essential.
                </p>

                <p>
                  Please make sure all details are correct when entering the
                  shipping information. If you notice any errors after
                  submitting, feel free to contact our customer support team to
                  make necessary changes before the order is dispatched.
                </p>
